...
public class Qes1_13 {
	...
	public static void main(String[] args) {
		...
		System.out.print(System.lineSeparator()); // 改行コード
		...
		double BMI2 = weight / Math.pow(height / 100, 2); // BMI
		...
		System.out.println("BMIは" + String.format("%.2f", BMI2) + "です"); // BMIを出力
		...
		double heightDouble = Double.parseDouble(heightStr); // 身長をint型に変換
		
		
		System.out.println("年齢は" + ageInt + "歳です。"); // 年齢を出力
		
		System.out.println("身長は" + heightDouble + "cmです。"); // 身長を出力
